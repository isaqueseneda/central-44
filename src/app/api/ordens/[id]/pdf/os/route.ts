...
import { loadLogoBase64, renderOSPage, MONTHS } from "@/lib/pdf-utils";
...
export async function GET(
  ...
  try {
    ...
    renderOSPage(doc, order as any, logoBase64);
    ...
    const filename = `OS-${order.orderNumber} ${storeName} ${now.getDate()} de ${monthSafe}.pdf`;
    ...
    console.error("[OS PDF] Error generating PDF:", error);
